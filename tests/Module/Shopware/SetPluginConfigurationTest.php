...
/**
 * Class SetPluginConfigurationTest
 * @package Portrino\Codeception\Tests\Module\Shopware
 */
class SetPluginConfigurationTest extends ShopwareTest
{
    /**
     *
     */
     ...
     * @test
     */
    public function setPluginConfigurationSuccessfully()
    {
        $this->shopware->setPluginConfiguration('Plugin', 'debug', '1');
    }
}

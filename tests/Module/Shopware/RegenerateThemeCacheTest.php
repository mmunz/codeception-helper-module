...
/**
 * Class RegenerateThemeCacheTest
 * @package Portrino\Codeception\Tests\Module\Shopware
 */
class RegenerateThemeCacheTest extends ShopwareTest
{
    /**
     *
     */
     ...
     * @test
     */
    public function regenerateThemeCacheSuccessfully()
    {
        $this->shopware->regenerateThemeCache();
    }
}
